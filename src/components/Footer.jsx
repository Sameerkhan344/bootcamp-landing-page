...
const Footer = () => {
  const aboutLinks = [
    ...
    { title: "Submit Projects", href: "" },
  ];

  const companyLinks = [
    { title: "Hire From Us", href: "" },
    { title: "Discord", href: "" },
    { title: "Pricing and Refund", href: "" },
    { title: "Jobs", href: "" },
  ];
    ...
    >
      <div className="relative z-10 w-full px-6 md:px-16 lg:px-24 pt-12 pb-10">
        <div className="flex flex-col md:flex-row gap-12 md:gap-10 lg:gap-20">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              {socialLinks.map((social) => (
                <Link
                  ...
                  className="w-12 h-12 rounded-full border border-white/25 flex items-center justify-center text-white/80 hover:bg-white/10 hover:text-white transition-all duration-200 shrink-0"
                >
                  {social.icon}
                </Link>
              ))}
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-12 lg:gap-20">
            <div>
              <h4 className="font-helvetica text-[1.3rem] font-medium text-white uppercase mb-5">
                About
              </h4>
              ...
              <ul className="flex flex-col gap-[14px]">
                {aboutLinks.map((link) => (
                  <li key={link.title}>
                    <Link
                      href={link.href}
                      className="font-helvetica text-[1.2rem] text-white/75 hover:text-white transition-colors duration-200"
                    >
                      {link.title}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                <div>
                  <p className="font-helvetica text-[1.2rem] font-bold text-white/90">
                    Online: 11am - 8pm
                  </p>

                  <a
                    href="tel:+919993478545"
                    className="font-helvetica text-[1.2rem] text-white/60 hover:text-white transition-colors"
                  >
                    +91 9993478545
                  </a>
                </div>
                ...
                <p className="font-helvetica text-[1.2rem] text-white/60 leading-relaxed">
                  23-B, Indrapuri Sector C, MP, 462001
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none select-none">
        <h1 className="font-helvetica text-[7rem] sm:text-[10rem] md:text-[14rem] lg:text-[20rem] font-semibold leading-none text-white/5 whitespace-nowrap">
          KODR
        </h1>
      </div>
    </footer>
